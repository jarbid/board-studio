...
Board Studio is free software, licensed under the **GNU General Public License,
...
Board Studio is a from-scratch modern rewrite — a TypeScript/WebGL re-imagining of
...
to golden reference data extracted from BoardCAD-LE, which makes Board Studio a
derivative work. We honor BoardCAD's copyleft by releasing Board Studio under the same
...
Board Studio's web app bundles open-source libraries including React, Three.js,
